...
extension Fractional {
    ...
    public var reciprocal: Fractional {
        return Fractional(self.denominator, self.numerator)
    }
    ...
    public var isInfinite: Bool {
        return self.denominator == 0 && self.numerator != 0
    }
...
extension Fractional: CustomStringConvertible {
    public var description: String {
        ...
        switch self.denominator {
            case 1: return "\(self.numerator)"
            default: return "\(self.numerator)/\(self.denominator)"
        }
    }
}
